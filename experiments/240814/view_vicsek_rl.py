...
# Load the data
ckp_num = '0059'
rl_path = f'../../data/240814/240814_RL_ckp{ckp_num}.npz'
vicsek_path = f'../../data/240814/240814_Vicsek_ckp{ckp_num}.npz'
try:
...
sv_dir = f'../../data/240814/figs/{ckp_num}'
...
plt.savefig(f'{sv_dir}/240814_avg_episode_reward.png')
plt.show()
...
plt.grid(axis='y', zorder=0)
plt.savefig(f'{sv_dir}/240814_avg_order_parameter.png')
plt.show()
...
plt.grid(axis='y', zorder=0)
plt.savefig(f'{sv_dir}/240814_avg_info_util_ratio.png')
plt.show()
...
for seed in range(num_seeds):
    ...
    plt.ylim(0, 1.03)
    plt.legend()
    plt.savefig(f'{sv_dir}/240814_s{seed}_info_util_ratio.png')
    # plt.show()
    plt.close()
...
for seed in range(num_seeds):
    ...
    plt.ylim(0, 1.02)
    plt.legend()
    plt.savefig(f'{sv_dir}/240814_s{seed}_order_parameter.png')
    # plt.show()
    plt.close()
